...
public class GXCommunicate {
    ...
    public GXCommunicate(int waitTime, GXDLMSSecureClient dlms,
        ...
        int value = 1;//manufacturer.getAuthentication(auth).getClientAddress();
        ...
        if (useIec47) {
            ...
            value = 1;//serv.getPhysicalAddress();
        } else {
            //dlms.setInterfaceType(InterfaceType.HDLC);
            dlms.setInterfaceType(InterfaceType.HDLC);
            //value = GXDLMSClient.getServerAddress(serv.getLogicalAddress(),
            value = GXDLMSClient.getServerAddress(0,
                    serv.getPhysicalAddress());
        }

        //value = GXDLMSClient.getServerAddress(1618103);
        //value = GXDLMSClient.getServerAddress(1652000);
